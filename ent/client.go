...
func (c *AnswerClient) QueryQuestion(a *Answer) *QuestionQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, true, answer.QuestionTable, answer.QuestionPrimaryKey...),
		)
...
// QueryOwn queries the own edge of a Question.
func (c *QuestionClient) QueryOwn(q *Question) *AnswerQuery {
...
// QueryIncluded queries the included edge of a Question.
func (c *QuestionClient) QueryIncluded(q *Question) *QuestionnaireQuery {
...
// QueryInclude queries the include edge of a Questionnaire.
func (c *QuestionnaireClient) QueryInclude(q *Questionnaire) *QuestionQuery {
	query := (&QuestionClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := q.ID
		step := sqlgraph.NewStep(
...
// QueryCreatedBy queries the created_by edge of a Questionnaire.
func (c *QuestionnaireClient) QueryCreatedBy(q *Questionnaire) *UserQuery {
...
func (c *UserClient) QueryCreate(u *User) *QuestionnaireQuery {
	query := (&QuestionnaireClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
...
type (
	hooks struct {
		Answer, Question, Questionnaire, User []ent.Hook
	}
	inters struct {
		Answer, Question, Questionnaire, User []ent.Interceptor
	}
)
