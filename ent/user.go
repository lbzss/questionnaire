...
type UserEdges struct {
	...
	Create []*Questionnaire `json:"create,omitempty"`
...
func (e UserEdges) CreateOrErr() ([]*Questionnaire, error) {
	if e.loadedTypes[0] {
		return e.Create, nil
	}
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldID, user.FieldGender, user.FieldUserType:
			values[i] = new(sql.NullInt64)
		case user.FieldUserName, user.FieldPhoneNumber:
...
func (u *User) QueryCreate() *QuestionnaireQuery {
