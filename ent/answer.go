...
type Answer struct {
	...
	// AnswerChoice holds the value of the "answer_choice" field.
	AnswerChoice int `json:"answer_choice,omitempty"`
	// AnswerText holds the value of the "answer_text" field.
	AnswerText string `json:"answer_text,omitempty"`
	// QuestionnaireID holds the value of the "questionnaire_id" field.
...
func (*Answer) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case answer.FieldID, answer.FieldAnswerChoice, answer.FieldQuestionnaireID, answer.FieldQuestionID:
	...
	for i := range columns {
		...
		case answer.FieldAnswerChoice:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field answer_choice", values[i])
			} else if value.Valid {
				a.AnswerChoice = int(value.Int64)
			}
		case answer.FieldAnswerText:
...
func (a *Answer) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("answer_choice=")
	builder.WriteString(fmt.Sprintf("%v", a.AnswerChoice))
	builder.WriteString(", ")
	builder.WriteString("answer_text=")
	builder.WriteString(a.AnswerText)
	builder.WriteString(", ")
	builder.WriteString("questionnaire_id=")
	builder.WriteString(fmt.Sprintf("%v", a.QuestionnaireID))
	builder.WriteString(", ")
